//
//  InvestmentsDetailsViewModel.swift
//  CGAAF
//
...
final class InvestmentsDetailsViewModel {
    
    //Func to create columns in NSTableView based on InvestmentsDetailsTableViewModel
